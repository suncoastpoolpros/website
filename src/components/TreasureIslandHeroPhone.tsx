...
// Desktop-only Gmail service-report phone mockup for the Treasure Island
// hero. Same shape as Belleair's phone but localized to a vacation-rental
// scenario — the visible email is the kind a Treasure Island rental owner
// would receive after each weekly visit.
// Lazy-loaded so phones/tablets never download this code or its ServiceReport
// dependency on first paint.
export const TreasureIslandHeroPhone = () => {
            ...
            <div className="absolute inset-[10px] rounded-[2.55rem] bg-[#f2f2f0] overflow-hidden">
              ...
              >
                ...
                >
                  ...
                  <ServiceReport
                    inline
                    customerName="Gulf Tide Rental"
                    customerAddress={
                      <>
                        Sunset Beach Cottage,{' '}
                        <span style={{ whiteSpace: 'nowrap' }}>Treasure Island, FL 33706</span>
                      </>
                    }
                    photo={{
...
export default TreasureIslandHeroPhone;
