...
// Desktop-only Gmail service-report phone mockup for the Snell Isle hero.
// Same shell as the other city pages, with the report localized to a Snell
// Isle estate address. Lazy-loaded so phones never download this code or its
// ServiceReport dependency on first paint.
export const SnellIsleHeroPhone = () => {
  ...
  return (
    ...
    >
      <div className="relative w-[300px] scale-90 origin-center">
              ...
              >
                ...
                >
                  ...
                  {/* The real report, inline so it joins the parent scroll.
                      Localized to a Snell Isle estate address. Photo is a
                      placeholder (waterfront image) until the dedicated Snell
                      Isle hero photo is added. */}
                  <ServiceReport
                    inline
                    customerName="The Brightwaters Estate"
                    customerAddress={
                      <>
                        Brightwaters Blvd NE,{' '}
                        <span style={{ whiteSpace: 'nowrap' }}>Snell Isle, St. Petersburg, FL 33704</span>
                      </>
                    }
                    photo={{
                      base: '/waterfront-pool-st-petersburg',
                      alt: 'Estate pool in Snell Isle, St. Petersburg, FL — cleaned and chemically balanced by Suncoast Pool Pros',
                    }}
                  />
                </div>
              </div>

              {/* Gmail reply/forward bar */}
              <div
        ...
        {/* Quiet ambient glow — deep Gulf-tone, fitting the established
            bayfront-estate feel rather than the brighter beach pages. */}
        <div className="absolute -top-6 -left-6 -right-6 bottom-12 bg-gradient-to-br from-brand-blue/15 via-brand-blue-dark/12 to-brand-blue/5 blur-3xl -z-10 rounded-[3rem]" />
      </div>
    </m.div>
  );
};

export default SnellIsleHeroPhone;
