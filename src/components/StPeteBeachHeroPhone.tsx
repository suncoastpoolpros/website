...
// Desktop-only Gmail service-report phone mockup for the St. Pete Beach hero.
// Same shell as the Treasure/Belleair phones, but the visible email is the
// report a St. Pete Beach beachfront owner would receive after a weekly visit.
// Lazy-loaded so phones/tablets never download this code or its ServiceReport
// dependency on first paint.
export const StPeteBeachHeroPhone = () => {
  ...
  return (
    ...
    >
      <div className="relative w-[300px] scale-90 origin-center">
                ...
                >
                  ...
                  <ServiceReport
                    ...
                    customerAddress={
                      <>
                        Gulf Blvd,{' '}
                        <span style={{ whiteSpace: 'nowrap' }}>St. Pete Beach, FL 33706</span>
                      </>
                    }
                    photo={{
        ...
        {/* Quiet ambient glow — Gulf-tone, slightly warmer than Treasure to
            read "sun-soaked beach" without leaving the brand palette. */}
        <div className="absolute -top-6 -left-6 -right-6 bottom-12 bg-gradient-to-br from-brand-blue/15 via-brand-blue-dark/10 to-brand-orange/10 blur-3xl -z-10 rounded-[3rem]" />
      </div>
    </m.div>
  );
};

export default StPeteBeachHeroPhone;
