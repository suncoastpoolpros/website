...
export const formatUsPhone = (input: string): string => {
  ...
  // Space after the area code, matching how the business writes its own number
  // everywhere else — "(727) 295-3621" in the footer, the schema and llms.txt.
  // Without it a customer-facing PDF printed "(727)555-0148", which reads as a
  // formatting slip on a document whose whole job is looking considered.
