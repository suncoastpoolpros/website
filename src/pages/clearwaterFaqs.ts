// FAQ source-of-truth for the Clearwater page. Its own tiny module so the page
// chunk can include it for JSON-LD without pulling in the rest of the
// below-the-fold React tree. Content is specific to Clearwater — a city that
// lives two lives at once: the barrier-island beach world (Clearwater Beach,
// Sand Key, Island Estates — salt systems, rentals, condos, full sun) and the
// big established mainland (Countryside, Morningside, Del Oro — screened cages,
// oak debris, full-time families). The page's whole angle is "the town named
// for clear water, kept clear," so the answers lean on that duality and on the
// clarity standard.
export const clearwaterFaqs = [
  ...
  },
  {
    ...
    a: "Not at all — it's a big part of what we do out on Sand Key and Clearwater Beach. Salt cells, full Gulf sun, and blowing sand are hard on water chemistry and on equipment, so beach pools need a steadier hand than an inland pool, not a lighter one. We check your salt cell every visit, keep your stabilizer and chlorine production dialed in for the sun load, and rinse the grit that turns a beach pool cloudy. It all rides on one flat rate.",
  },
  {
    q: 'I rent my Clearwater Beach place out — can you keep it guest-ready?',
    a: "Yes, and a lot of our island clients are exactly that — owners with a vacation rental or a condo they're not on-site to watch. We service on a dependable weekly day so the pool is always clear for the next check-in, send a photo report after every visit so you can see it from anywhere, and flag anything that needs attention before a guest ever notices. You don't have to be in town for your pool to be turn-ready.",
  },
  {
    q: "My mainland pool is screened in under big oaks — do you handle the debris?",
